...
CREATE TABLE `descuento_anio_egreso` (
  `id` int NOT NULL,
  `anio_inferior` year NOT NULL,
  `anio_superior` year NOT NULL,
...
CREATE TABLE `estudiante_descuento` (
  ...
  CONSTRAINT `estudiante_descuento_estudiante_id_fk` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id`),
...
CREATE TABLE `examen` (
  ...
  CONSTRAINT `examen_estudiante_id_fk` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pago` (
  ...
  CONSTRAINT `pago_estudiante_id_fk` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `razon` (
  ...
  CONSTRAINT `razon_estudiante_id_fk` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id`),
...
-- Dump completed on 2023-09-15 17:09:21
